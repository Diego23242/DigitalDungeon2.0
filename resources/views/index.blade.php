...
@section('seccion')
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="Img/banner Minecraft.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="Img/Banner COD.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="Img/Ziggurat.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="Img/Loop Hero.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="Img/banner Battelfield.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card text-dark card-border"> 
                    <img src="Img/noticias1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card text-dark  card-border">
                    <img src="Img/noticias2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
    ...
    <div class="container mt-5 text-light">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card text-dark  card-border">
                    <img src="Img/noticias5.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card text-dark  card-border">
                    <img src="Img/noticias6.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
